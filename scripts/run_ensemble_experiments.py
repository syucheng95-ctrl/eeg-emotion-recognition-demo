...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate holdout ensemble variants by retraining selected candidates without leakage.")
...
def build_model_specs(outputs_root: Path) -> list[dict[str, object]]:
    specs = [
        {
            "name": "cand1_seed42",
            "report_file": "phaseA_lambda_0p02_report.json",
            "family": "cand1",
            "seed": 42,
        },
        {
            "name": "cand1_seed52",
            "report_file": "cand1_lambda0p02_vec_d0p3_gru1_seed52_report.json",
            "family": "cand1",
            "seed": 52,
        },
        {
            "name": "cand1_seed62",
            "report_file": "cand1_lambda0p02_vec_d0p3_gru1_seed62_report.json",
            "family": "cand1",
            "seed": 62,
        },
        {
            "name": "cand2_seed42",
            "report_file": "phaseD_gru2_report.json",
            "family": "cand2",
            "seed": 42,
        },
        {
            "name": "cand2_seed52",
            "report_file": "cand2_lambda0p02_vec_d0p3_gru2_seed52_report.json",
            "family": "cand2",
            "seed": 52,
        },
        {
            "name": "cand2_seed62",
            "report_file": "cand2_lambda0p02_vec_d0p3_gru2_seed62_report.json",
            "family": "cand2",
            "seed": 62,
        },
        {
            "name": "cand3_seed42",
            "report_file": "phaseC_dropout_0p4_report.json",
            "family": "cand3",
            "seed": 42,
        },
        {
            "name": "cand3_seed52",
            "report_file": "cand3_lambda0p02_vec_d0p4_gru1_seed52_report.json",
            "family": "cand3",
            "seed": 52,
        },
        {
            "name": "cand3_seed62",
            "report_file": "cand3_lambda0p02_vec_d0p4_gru1_seed62_report.json",
            "family": "cand3",
            "seed": 62,
        },
    ]
...
def main() -> None:
    ...
    family_names = {
        "cand1": [spec["name"] for spec in model_specs if spec["family"] == "cand1"],
        "cand2": [spec["name"] for spec in model_specs if spec["family"] == "cand2"],
        "cand3": [spec["name"] for spec in model_specs if spec["family"] == "cand3"],
    }
    experiments = []
    for family, names in family_names.items():
        experiments.append({"ensemble_name": f"{family}_seed_avg", "members": names, "method": "soft_avg_equal"})
        experiments.append({"ensemble_name": f"{family}_seed_cv_weighted", "members": names, "method": "soft_avg_cv_weighted"})

    phase42_names = ["cand1_seed42", "cand2_seed42", "cand3_seed42"]
    top6_names = ["cand1_seed42", "cand1_seed52", "cand2_seed42", "cand2_seed52", "cand3_seed42", "cand3_seed52"]
    all_names = [spec["name"] for spec in model_specs]
    experiments.extend(
        [
            {"ensemble_name": "top3_equal", "members": phase42_names, "method": "soft_avg_equal"},
            {"ensemble_name": "top3_cv_weighted", "members": phase42_names, "method": "soft_avg_cv_weighted"},
            {"ensemble_name": "top3_majority_vote", "members": phase42_names, "method": "hard_vote"},
            {"ensemble_name": "top6_equal", "members": top6_names, "method": "soft_avg_equal"},
            {"ensemble_name": "all9_equal", "members": all_names, "method": "soft_avg_equal"},
            {"ensemble_name": "all9_cv_weighted", "members": all_names, "method": "soft_avg_cv_weighted"},
            {"ensemble_name": "all9_majority_vote", "members": all_names, "method": "hard_vote"},
        ]
    )
    ...
    summary_path = paths.outputs_root / "ensemble_experiment_summary.csv"
